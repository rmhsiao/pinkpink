            ...
            public void onMenuTabSelected(@IdRes int menuItemId) {
                ...
                switch (menuItemId) {
                    case R.id.bb_menu_memorialday:
                        Intent go2 = new Intent(SiteActivity.this, HomePageActivity.class);
                        startActivity(go2);
                        break;
                    case R.id.bb_menu_site:
                        break;
                    case R.id.bb_menu_trip:
                        Toast.makeText(SiteActivity.this, "敬請期待", Toast.LENGTH_LONG).show();
                        mBottomBar.selectTabAtPosition(1,true);
                        break;
                }
            }
...
//        rb.setRating(val);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_memberData) {
            // 設定從這個活動跳至 home 的活動
            Intent intent = new Intent(SiteActivity.this, MemberData.class);
            // 開始跳頁
            startActivity(intent);
        } else if (id == R.id.nav_memorialDay) {
            // 設定從這個活動跳至 home 的活動
            Intent intent = new Intent(SiteActivity.this, ModifyMemorialDay.class);
            // 開始跳頁
            startActivity(intent);

        } else if (id == R.id.nav_myViewpoint) {
            Intent go2 = new Intent(SiteActivity.this, ManageSiteActivity.class);
            startActivity(go2);

        } else if (id == R.id.nav_myTravle) {
            Intent go2 = new Intent(SiteActivity.this, SiteActivity.class);
            startActivity(go2);

        } else if (id == R.id.nav_travleEdit) {
            Intent go2 = new Intent(SiteActivity.this, SiteInfoActivity.class);
            startActivity(go2);

        } else if (id == R.id.nav_logout) {
            Intent go2 = new Intent(SiteActivity.this, SiteRestaurantActivity.class);
            startActivity(go2);
        } else if (id == R.id.my_attraction) {
            Intent go2 = new Intent(SiteActivity.this, MyAttractionActivity.class);
            startActivity(go2);
        } else if (id == R.id.my_restaurant) {
            Intent go2 = new Intent(SiteActivity.this, MyRestaurantActivity.class);
            startActivity(go2);
        }
